...
public class P2PSocket extends java.net.Socket {
    private static final Logger log = Logger.getLogger(P2PSocket.class.getName());
    ...
    public P2PSocket(String host, int port)
        ...
        log.debug("creating address for "+host+":"+port);
    ...
    private void connectSocket() throws IOException {
        ...
        log.debug("Connect to "+remoteSocketAddress);
