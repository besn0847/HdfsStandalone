...
public final class P2PSocketLeaseManager implements Runnable{
	private static final Logger LOG = Logger.getLogger(P2PSocketLeaseManager.class.getName());
	/**
    ...
    public void run(){
        ...
        while(running && (reference.get() != null)){
            try{
            	LOG.debug("Publishing managed adv");
        ...
        LOG.debug("Stop Publishing managed adv!!..!!");
    }
