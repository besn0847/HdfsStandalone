...
public class P2PSocketLooupManager implements Runnable {
    ...
    private static final Logger log = Logger.getLogger(P2PSocketLooupManager.class.getName());
        ...
        while(running){
            try{
                ...
                try{
                    ...
                    log.error("Exception while processing adv cache. We'll continue any way...");
                    ioe.printStackTrace();
                }
